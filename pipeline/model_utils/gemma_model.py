...
GEMMA2_CHAT_TEMPLATE = """<start_of_turn>user
{instruction}<end_of_turn>
<start_of_turn>model
"""

GEMMA2_REFUSAL_TOKS = [235285]  # ['I']
...
class GemmaModel(ModelBase):
    ...
    def _get_eoi_toks(self):
        return self.tokenizer.encode(GEMMA2_CHAT_TEMPLATE.split("{instruction}")[-1], add_special_tokens=False)

    def _get_refusal_toks(self):
        return GEMMA2_REFUSAL_TOKS
